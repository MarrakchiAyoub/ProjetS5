...
if(isset($_POST['send'])) {
	...
	$m="";
	$c="projet";
	$cnt=mysqli_connect($s,$r,$m,$c);
	if(!$cnt){die("Connection failed: ". mysqli_connect_error());}
	...
	if(mysqli_num_rows($result)!=0)
	 ...
	 echo '<a href="insert.html"> réessayer avec un autre login</a>';
	 }
 else {
	 $sql="insert into connexion (login, pswd, email) values ('$login','$password','$email')";
		 if(mysqli_query($cnt, $sql))
			 ...
			 echo '<a href="insert.html"> veillez réesseyer à nouveaux</a>';
			 }
	 }	 
						 }else {echo "error";} 
?>
...
Resaisir le <br>mot de passe: <input class="r" name="n_psw" type="password"><br><br>
E-mail:<input class="i" name="email" type="text" style="margin-left: 40px"><br><br>
