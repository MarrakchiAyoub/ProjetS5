...
return false;
        ...
        <div class="d3">
            <form mothod="POST" name="seance" onsubmit="return checkgroup()">
                ...
                <p class="d1">Le jour de la sceance que vous voulez modifier :</p>
					...
					<option value=4>15:30 - 17:15</option>
                        ...
                        <p class="d1"> Quand voulez-vous la rendre ?</p>
                    <div class="sel sel--black-panther3">    
					<select name="day2">
					<option value="Monday">Lundi</option>
					<option value="Tuesday">Mardi</option>
					<option value="Wednesday">Mercredi</option>
					...
					<option value=4>15:30 - 17:15</option>
                        ...
                        <hr class="rule">
                    <div class="d2">
                        <p class="d1">La salle:</p>
                        <input type="text" name="sal" placeholder="Ex: E23"> 
                        <hr class="rule">
                        <p class="d1"> Applique les modification a partir de :</p> 
                        <input type="radio" value="today" name="debut"> La seance prochaine
                        <input type="radio" value="next week" name="debut"> La seance d'apres 
                    </div>
                    <br>
					<button type="submit" name="valid-mod" formmethod="post" class="blue">Valide</button>
	 			</form>
			</div>
